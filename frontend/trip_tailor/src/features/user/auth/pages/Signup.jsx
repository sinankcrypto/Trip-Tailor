...
import { useGoogleLogin } from "../hooks/useGoogleLogin"; // ✅ import hook
...
const Signup = () => {
  ...
  const { googleLogin } = useGoogleLogin(); // ✅ use googleLogin hook
  ...
  // ✅ Google Login handler using hook
  const handleGoogleLogin = async (googleUser) => {
    const idToken = googleUser.credential;
    await googleLogin(idToken, role); // just call the hook
  };
  ...
  return (
    <div className="w-full p-10 bg-white font-[Lexend]">
      ...
      <h2 className="text-2xl font-bold text-center text-gray-800 mb-2">
        ...
        <br className="hidden md:block" /> Experience it!
      </h2>
      ...
      <div className="mt-4" id="google-signup-btn"></div>
